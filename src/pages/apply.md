  ...
  - type: apply_section
    ...
    content: 
        content_first: >-
            ...
            <a href="#" class="doc">Έγγραφα Ταυτοποίησης Φυσικών Προσώπων</a>
    actions:
      - label: Αίτηση
        url: /#
        style: primary 
  ...
  - type: apply_section
    ...
    content: 
        ...
        content_first: >-
            ...
            <a href="#" class="doc">Νομιμοποιητικά έγγραφα - Νομικά Πρόσωπα Αλλοδαπής</a>
            <a href="#" class="doc">Νομιμοποιητικά έγγραφα - Νομικά Πρόσωπα Ημεδαπής</a>
    actions:
      - label: Αίτηση
        url: /#
        style: primary 
