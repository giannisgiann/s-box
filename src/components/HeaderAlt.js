            ...
            <header className={classnames("site-header header-alt",{
              ...
              <div className="container container--lg">
                <nav className="navbar" aria-label="Main Navigation">
                  ...
                  {_.get(this.props, 'pageContext.site.siteMetadata.header_alt.logo', null) ? (
                  <Link className="navbar__logo" to={withPrefix('/')}><img src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.header_alt.logo', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header_alt.logo_alt', null)} /></Link>
                  ) : 
                  <Link className="h4 navbar__title" to={withPrefix('/')}>{_.get(this.props, 'pageContext.site.siteMetadata.header_alt.title', null)}</Link>
                  }
                  {_.get(this.props, 'pageContext.site.siteMetadata.header_alt.has_nav', null) && (<React.Fragment>
                    ...
                    <div className="navbar__scroller">
                      <div className="navbar__inner">
                        ...
                        <ul className="navbar__list menu">
                          {_.map(_.get(this.props, 'pageContext.site.siteMetadata.header_alt.nav_links', null), (action, action_idx) => {
